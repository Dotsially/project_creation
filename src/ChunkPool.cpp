...
void ChunkPool::InitializeChunkPool(i32 renderDistance){
    chunkMeshes = new ChunkMesh[(renderDistance*2+1)*(renderDistance*2+1) + (renderDistance*2+1) +1];
    chunkPoolSize = (renderDistance*2+1)*(renderDistance*2+1) + (renderDistance*2+1) +1;
}
